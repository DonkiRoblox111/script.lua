...
local Tabs = {
    ...
    Shop = Window:AddTab({ Title = "Bán Đồ", Icon = "shopping-cart" }),
	Misc = Window:AddTab({ Title = "Thứ Khác", Icon = "list-plus" }),
}
